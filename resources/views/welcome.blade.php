...
<div class="about" style="display: block">
    ...
    <p>Так выглядит файл до обработки:</p>
    <img src="{{ asset('/before.png') }}" alt="Файл до обработки">
    <p>Файл после обработки:</p>
    <img src="{{ asset('/after.png') }}" alt="Файл после обработки">
